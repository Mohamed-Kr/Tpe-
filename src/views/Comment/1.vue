  ...
  <v-layout justify-center align-center fill-height>
    <v-flex xs11 md9 lg10 xl8>
      <v-card class='subheading mx-3 px-3 transparent' flat>
        <v-card-title class='headline white--text'>Si on réfléchit bien: sans consomation, pas besoin de production.
        </v-card-title>
      </v-card>
...
-la consommation en france reste assez stable, entre 450 TWh et 500 TWh, pourtant la consommation des ménages est en constante augmentation, mais cette augmentation est compensé par la baisse de consommation au niveau des industries due à la mondialisation.



II.C.1 Comment réduire la conso°
thermosensibilité: norme RT2012 : en conséquence il faut réduire la part du chauffage électrique dans les nouveau bâtiments
éclairage intelligent
ampoules halogènes par des ampoules plus performante (LED, fluorescente)
l'ADEME: le terme “gisements d'économie d'énergie”
l'éclairage nocturne inutile
publicité
		  </v-card>
        </v-card-text>
      </v-card>
