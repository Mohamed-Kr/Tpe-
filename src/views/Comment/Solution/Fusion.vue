		...
		<v-card-text class="pa-3">
			...
			<v-card class='px-3 text-sm-justify	' flat>
				<div>
					...
					<br>
					<br>
					Il existe actuellement plusieurs équipe scientifiques internationnalles travaillant sur un réacteur capable de recréer la fusion :
					<br>
					<br>
					<ul>
					...
					de produire beaucoup moins de déchets à haute activité radioactive. Cette méthode est aussi avantageuse car les combustibles sont facilement procurable,
					...
					rend très compliqué à mettre en place sur le court terme. Il s'agit donc d'une technologie de long terme.
				</div>
			</v-card>
		</v-card-text>
	</v-card>
