...
<v-container>
  <v-layout justify-center align-center fill-height>
    <v-flex xs11 md12 lg10 xl8>
          ...
          >Pour produire de l'électricité, il faut donc trouver une énérgie exploitable mais
      ...
      <v-card class='subheading mx-5 mt-4 pa-3'>
        ...
        <v-card-text>
          ...
          >Comme nous venons de le voir, nous ne créons pas de l'énérgie mais nous la transformons,
					...
					utile et inutile. La partie utile est l'énérgie électrique, et l'inutile est par exemple, la
					chaleur que produit une bobine de cuivre à cause de sa résistance électrique suite à l'induction.
          </v-card>
					<v-card class='mt-2 px-3' flat
          >Le rendement d'un moyen de production électrique correspond donc à la part d'énérgie utile
					par rapport à l'énérgie consommé par la transformation, il peut être interpreté comme la
					 rentabilité d'un moyen de production électrique et est généralement éxprimé en pourcentage.
          </v-card>
        </v-card-text>
      </v-card>
      <v-card class='subheading ma-5 pa-3'>
        ...
        <v-card-text>
          ...
          >A tout instant, sur un réseau électrique, la production doit égaler la consommation.
					...
					<v-card class='mt-2 px-3' flat
          >Nos capacité en stockage électrique ne sont actuellement pas assez avancées pour être utiles sur une si grande echelle,
          ...
          >Par exemple, du côté des énergies renouvelable, les panneaux photovoltaïques ne sont pas pilotables
					contrairement aux barrages hydroélectriques, étant dotés de pales orientables, permetant d’ajuster
					la vitesse du rotor.
          </v-card>
        </v-card-text>
      </v-card>
        ...
        <v-card-text>
          ...
          >Le secteur de l'électricité est unique parmi les secteurs
            ...
            du dioxyde de carbone, un gaz qui contribue à l'effet de serre.
					...
					<v-card class='mt-2 px-3' flat
          >Nous résumons souvent l'impact de la production électrique sur l'environement à la polution et ses conséquences mais en réalité,
